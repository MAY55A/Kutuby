...
public class KutubyApplication {
    ...
    CommandLineRunner commandLineRunnerBooks(BookService bookService){
        ...
        return args-> {
            bookService.addBook(new Book("IceBreaker", "Hannah Grace", "English", "images/book1.jpg",
            ...
            bookService.addBook(new Book("It Ends With Us", "Colleen Hoover", "English", "images/book2.jpg",
                    Set.of(Genre.ROMANCE), dateFormat.parse("2020-07-26"),
                    "In this “brave and heartbreaking novel that digs its claws into you and doesn’t let go, long after you’ve finished it” (Anna Todd, New York Times bestselling author) from the #1 New York Times bestselling author of All Your Perfects, a workaholic with a too-good-to-be-true romance can’t stop thinking about her first love.", 40));
            bookService.addBook(new Book("It Starts With Us", "Colleen Hoover", "English", "images/book3.jpg",
            ...
            bookService.addBook(new Book("Rich Dad Poor Dad - What the Rich Teach Their Kids About Money", "Robert T. Kiyosaki", "English", "images/book6.jpg",
            ...
            bookService.addBook(new Book("The Lord of the Rings", "J.R.R. Tolkien", "English", "images/book6.jpg",
            ...
            bookService.addBook(new Book("To Kill a Mockingbird", "Harper Lee", "English", "images/book4.jpg",
            ...
            bookService.addBook(new Book("1984", "George Orwell", "English", "images/1984.jpg",
            ...
            bookService.addBook(new Book("Murder on the Orient Express", "Agatha Christie", "English", "images/book7.jpg",
            ...
            bookService.addBook(new Book("The Da Vinci Code", "Dan Brown", "English", "images/book9.jpg",
            ...
            bookService.addBook(new Book("The Diary of a Young Girl", "Anne Frank", "English", "images/book11.jpg",
            ...
            bookService.addBook(new Book("It", "Stephen King", "English", "images/book18.jpg",
            ...
            bookService.addBook(new Book("The Seven Habits of Highly Effective People", "Stephen R. Covey", "English", "images/book17.jpg",
            ...
            bookService.addBook(new Book("A Brief History of Time", "Stephen Hawking", "English", "images/book16.jpg",
            ...
            bookService.addBook(new Book("Good Omens", "Terry Pratchett, Neil Gaiman", "English", "images/book15.jpg",
            ...
            bookService.addBook(new Book("On the Road", "Jack Kerouac", "English", "images/book14.jpg",
            ...
            bookService.addBook(new Book("Ethics", "Baruch Spinoza", "English", "images/book13.jpg",
            ...
            bookService.addBook(new Book("Atlas of the Heart", "Brené Brown", "English", "images/book12.jpg",
            ...
            bookService.addBook(new Book("Atomic Habits", "James Clear", "English", "images/book10.jpg",
